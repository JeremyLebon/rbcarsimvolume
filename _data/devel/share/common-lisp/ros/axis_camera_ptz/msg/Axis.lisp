...
(cl:in-package axis_camera_ptz-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Axis>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Axis)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name axis_camera_ptz-msg:<Axis> is deprecated: use axis_camera_ptz-msg:Axis instead.")))

(cl:ensure-generic-function 'pan-val :lambda-list '(m))
(cl:defmethod pan-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:pan-val is deprecated.  Use axis_camera_ptz-msg:pan instead.")
  (pan m))

(cl:ensure-generic-function 'tilt-val :lambda-list '(m))
(cl:defmethod tilt-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:tilt-val is deprecated.  Use axis_camera_ptz-msg:tilt instead.")
  (tilt m))

(cl:ensure-generic-function 'zoom-val :lambda-list '(m))
(cl:defmethod zoom-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:zoom-val is deprecated.  Use axis_camera_ptz-msg:zoom instead.")
  (zoom m))

(cl:ensure-generic-function 'focus-val :lambda-list '(m))
(cl:defmethod focus-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:focus-val is deprecated.  Use axis_camera_ptz-msg:focus instead.")
  (focus m))

(cl:ensure-generic-function 'brightness-val :lambda-list '(m))
(cl:defmethod brightness-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:brightness-val is deprecated.  Use axis_camera_ptz-msg:brightness instead.")
  (brightness m))

(cl:ensure-generic-function 'iris-val :lambda-list '(m))
(cl:defmethod iris-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:iris-val is deprecated.  Use axis_camera_ptz-msg:iris instead.")
  (iris m))

(cl:ensure-generic-function 'autofocus-val :lambda-list '(m))
(cl:defmethod autofocus-val ((m <Axis>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:autofocus-val is deprecated.  Use axis_camera_ptz-msg:autofocus instead.")
  (autofocus m))
