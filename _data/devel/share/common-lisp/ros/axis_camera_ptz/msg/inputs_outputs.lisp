...
(cl:defmethod cl:initialize-instance :after ((m <inputs_outputs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'inputs_outputs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name axis_camera_ptz-msg:<inputs_outputs> is deprecated: use axis_camera_ptz-msg:inputs_outputs instead.")))

(cl:ensure-generic-function 'digital_inputs-val :lambda-list '(m))
(cl:defmethod digital_inputs-val ((m <inputs_outputs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:digital_inputs-val is deprecated.  Use axis_camera_ptz-msg:digital_inputs instead.")
  (digital_inputs m))

(cl:ensure-generic-function 'digital_outputs-val :lambda-list '(m))
(cl:defmethod digital_outputs-val ((m <inputs_outputs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:digital_outputs-val is deprecated.  Use axis_camera_ptz-msg:digital_outputs instead.")
  (digital_outputs m))

(cl:ensure-generic-function 'analog_inputs-val :lambda-list '(m))
(cl:defmethod analog_inputs-val ((m <inputs_outputs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:analog_inputs-val is deprecated.  Use axis_camera_ptz-msg:analog_inputs instead.")
  (analog_inputs m))

(cl:ensure-generic-function 'analog_outputs-val :lambda-list '(m))
(cl:defmethod analog_outputs-val ((m <inputs_outputs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:analog_outputs-val is deprecated.  Use axis_camera_ptz-msg:analog_outputs instead.")
  (analog_outputs m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<inputs_outputs>)))
  ...
  "axis_camera_ptz/inputs_outputs")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'inputs_outputs)))
  "Returns string type for a message object of type 'inputs_outputs"
  "axis_camera_ptz/inputs_outputs")
