...
(cl:defmethod cl:initialize-instance :after ((m <ptz>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ptz)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name axis_camera_ptz-msg:<ptz> is deprecated: use axis_camera_ptz-msg:ptz instead.")))
...
(cl:defmethod relative-val ((m <ptz>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-msg:relative-val is deprecated.  Use axis_camera_ptz-msg:relative instead.")
  (relative m))
