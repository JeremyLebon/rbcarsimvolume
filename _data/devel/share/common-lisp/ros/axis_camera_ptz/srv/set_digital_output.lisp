...
(cl:defmethod cl:initialize-instance :after ((m <set_digital_output-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_digital_output-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name axis_camera_ptz-srv:<set_digital_output-request> is deprecated: use axis_camera_ptz-srv:set_digital_output-request instead.")))

(cl:ensure-generic-function 'output-val :lambda-list '(m))
(cl:defmethod output-val ((m <set_digital_output-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-srv:output-val is deprecated.  Use axis_camera_ptz-srv:output instead.")
  (output m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <set_digital_output-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-srv:value-val is deprecated.  Use axis_camera_ptz-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_digital_output-request>)))
  ...
  "axis_camera_ptz/set_digital_outputRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_digital_output-request)))
  "Returns string type for a service object of type 'set_digital_output-request"
  "axis_camera_ptz/set_digital_outputRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <set_digital_output-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_digital_output-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name axis_camera_ptz-srv:<set_digital_output-response> is deprecated: use axis_camera_ptz-srv:set_digital_output-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_digital_output-response>)))
  ...
  "axis_camera_ptz/set_digital_outputResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_digital_output-response)))
  "Returns string type for a service object of type 'set_digital_output-response"
  "axis_camera_ptz/set_digital_outputResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_digital_output)))
  ...
  "axis_camera_ptz/set_digital_output")