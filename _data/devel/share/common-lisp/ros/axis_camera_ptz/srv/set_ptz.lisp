...
(cl:in-package axis_camera_ptz-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <set_ptz-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_ptz-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name axis_camera_ptz-srv:<set_ptz-request> is deprecated: use axis_camera_ptz-srv:set_ptz-request instead.")))

(cl:ensure-generic-function 'pan-val :lambda-list '(m))
(cl:defmethod pan-val ((m <set_ptz-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-srv:pan-val is deprecated.  Use axis_camera_ptz-srv:pan instead.")
  (pan m))

(cl:ensure-generic-function 'tilt-val :lambda-list '(m))
(cl:defmethod tilt-val ((m <set_ptz-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-srv:tilt-val is deprecated.  Use axis_camera_ptz-srv:tilt instead.")
  (tilt m))

(cl:ensure-generic-function 'zoom-val :lambda-list '(m))
(cl:defmethod zoom-val ((m <set_ptz-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-srv:zoom-val is deprecated.  Use axis_camera_ptz-srv:zoom instead.")
  (zoom m))

(cl:ensure-generic-function 'relative-val :lambda-list '(m))
(cl:defmethod relative-val ((m <set_ptz-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-srv:relative-val is deprecated.  Use axis_camera_ptz-srv:relative instead.")
  (relative m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_ptz-request>)))
  ...
  "axis_camera_ptz/set_ptzRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_ptz-request)))
  "Returns string type for a service object of type 'set_ptz-request"
  "axis_camera_ptz/set_ptzRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <set_ptz-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_ptz-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name axis_camera_ptz-srv:<set_ptz-response> is deprecated: use axis_camera_ptz-srv:set_ptz-response instead.")))

(cl:ensure-generic-function 'ret-val :lambda-list '(m))
(cl:defmethod ret-val ((m <set_ptz-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader axis_camera_ptz-srv:ret-val is deprecated.  Use axis_camera_ptz-srv:ret instead.")
  (ret m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<set_ptz-response>)))
  ...
  "axis_camera_ptz/set_ptzResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'set_ptz-response)))
  "Returns string type for a service object of type 'set_ptz-response"
  "axis_camera_ptz/set_ptzResponse")
