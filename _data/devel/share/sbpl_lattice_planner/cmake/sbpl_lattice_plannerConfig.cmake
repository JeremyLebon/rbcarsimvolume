...
if("TRUE" STREQUAL "TRUE")
  set(sbpl_lattice_planner_SOURCE_PREFIX /root/catkin_ws/src/navigation_experimental/sbpl_lattice_planner)
  set(sbpl_lattice_planner_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(sbpl_lattice_planner_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/devel/include;/root/catkin_ws/src/navigation_experimental/sbpl_lattice_planner/include;/opt/ros/melodic/include " STREQUAL " ")
  set(sbpl_lattice_planner_INCLUDE_DIRS "")
  set(_include_dirs "/root/catkin_ws/devel/include;/root/catkin_ws/src/navigation_experimental/sbpl_lattice_planner/include;/opt/ros/melodic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sbpl_lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/navigation_experimental/sbpl_lattice_planner/${idir}'.  ${_report}")
    endif()
    _list_append_unique(sbpl_lattice_planner_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "sbpl_lattice_planner;/opt/ros/melodic/lib/libsbpl.so")
...
set(sbpl_lattice_planner_EXPORTED_TARGETS "sbpl_lattice_planner_generate_messages_cpp;sbpl_lattice_planner_generate_messages_eus;sbpl_lattice_planner_generate_messages_lisp;sbpl_lattice_planner_generate_messages_nodejs;sbpl_lattice_planner_generate_messages_py;sbpl_lattice_planner_gencfg")
...
set(depends "roscpp;costmap_2d;nav_core;pluginlib;tf2;geometry_msgs;nav_msgs;message_runtime")
